...
class TestExercises:
    ...
    def test_get_exercises(self,
                           ...
                           function_course: CoursesFixture,
                           function_exercise: ExerciseFixture):
        parent_course_id = function_course.response.course.id
        exercises_response = exercises_client.get_exercises_api(parent_course_id)
        exercises_response_data = GetExercisesResponseSchema.model_validate_json(exercises_response.text)

        assert_status_code(exercises_response.status_code, HTTPStatus.OK)
        assert_get_exercises_response(exercises_response_data, [function_exercise.response])
        validate_json_schema(exercises_response.json(), exercises_response_data.model_json_schema())
