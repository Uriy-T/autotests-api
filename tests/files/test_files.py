...
class TestFiles:
    ...
    def test_get_file(self, files_client: FilesClient, function_file: FileFixture):
        response = files_client.get_file_by_id_api(function_file.response.file.id)
    ...
    def test_create_file_with_empty_filename(self, files_client: FilesClient):
        ...
        assert_create_file_with_empty_file_name_response(response_data)
    ...
    def test_create_file_with_empty_directory(self, files_client: FilesClient):
        ...
        assert_status_code(response.status_code, HTTPStatus.UNPROCESSABLE_ENTITY)
        assert_create_file_with_empty_directory_name_response(response_data)
    ...
    def test_delete_file(self, files_client: FilesClient, function_file: FileFixture):
        ...
        get_response = files_client.get_file_by_id_api(function_file.response.file.id)
    ...
    def test_get_file_with_incorrect_file_id(self, files_client: FilesClient, function_file: FileFixture):
        get_response = files_client.get_file_by_id_api('incorrect-file-id')
